...
export default function Home() {
  ...
  return (
    <main  className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-8" id="home-page">
      <div className="max-w-2xl w-full text-center">
        <h1 className=" font-bold text-gray-900 mb-4">
          Welcome to the Journal of Inter Discourse Academia
        </h1>
        <p className="text-xl text-lime-5 mb-8">
